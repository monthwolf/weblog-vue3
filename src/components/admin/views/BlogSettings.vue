                ...
                <div class="profile-section">
                    <div class="profile-header">
                        ...
                        <div class="user-roles">
                            <el-tag v-for="role in userStore.userInfo.roles" :key="role" class="role-tag" type="primary"
                                effect="light">
                                {{ role }}
                            </el-tag>
                        </div>
                        <div class="social-links">
                            <a v-if="settingsForm.githubHomepage" :href="settingsForm.githubHomepage" target="_blank">
                                <i class="fab fa-github"></i>
                            </a>
                            <a v-if="settingsForm.giteeHomepage" :href="settingsForm.giteeHomepage" target="_blank">
                                <i class="fab fa-git-alt"></i>
                            </a>
                            <a v-if="settingsForm.csdnHomepage" :href="settingsForm.csdnHomepage" target="_blank">
                                <i class="fas fa-code"></i>
                            </a>
                            <a v-if="settingsForm.zhihuHomepage" :href="settingsForm.zhihuHomepage" target="_blank">
                                <i class="fas fa-book-reader"></i>
                            </a>
                        </div>
                        <p class="profile-intro">{{ settingsForm.introduction || '这个人很懒，什么都没写~' }}</p>
                    </div>
                </div>

                <!-- 右侧设置表单 -->
                <div class="settings-form">
                    <el-form ref="formRef" :model="settingsForm" :rules="rules" label-width="100px" v-loading="loading">
                                ...
                                <div class="section-content">
                                    ...
                                    <el-form-item label="博客Logo" prop="logo">
                                        <el-upload class="logo-uploader" :show-file-list="false"
                                            :before-upload="beforeLogoUpload" :http-request="uploadLogo">
                                            <div class="relative">
                                    ...
                                    <el-form-item label="作者名称" prop="author">
                                        <el-input v-model="settingsForm.author" placeholder="请输入作者名称" />
                                    </el-form-item>
                                    <el-form-item label="个人介绍" prop="introduction">
                                        <el-input type="textarea" v-model="settingsForm.introduction" :rows="3"
                                            placeholder="请输入个人介绍" resize="none" />
                                    </el-form-item>
                                </div>
                            </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="section-content">
                                    <el-form-item label="GitHub">
                                        <el-input v-model="settingsForm.githubHomepage" placeholder="GitHub主页地址">
                                            <template #prefix><i class="fab fa-github"></i></template>
                                        </el-input>
                                    </el-form-item>
                                    <el-form-item label="Gitee">
                                        <el-input v-model="settingsForm.giteeHomepage" placeholder="Gitee主页地址">
                                            <template #prefix><i class="fab fa-git-alt"></i></template>
                                        </el-input>
                                    </el-form-item>
                                    <el-form-item label="CSDN">
                                        <el-input v-model="settingsForm.csdnHomepage" placeholder="CSDN主页地址">
                                            <template #prefix><i class="fas fa-code"></i></template>
                                        </el-input>
                                    </el-form-item>
                                    <el-form-item label="知乎">
                                        <el-input v-model="settingsForm.zhihuHomepage" placeholder="知乎主页地址">
                                ...
                                <el-form :model="passwordForm" :rules="passwordRules" ref="passwordFormRef"
                                    ...
                                    <el-form-item prop="currentPassword">
                                        <el-input v-model="passwordForm.currentPassword" type="password"
                                            placeholder="当前密码" :prefix-icon="Lock" show-password />
                                    </el-form-item>
                                    ...
                                    <el-form-item prop="confirmPassword">
                                        <el-input v-model="passwordForm.confirmPassword" type="password"
                                            placeholder="确认新密码" :prefix-icon="Lock" show-password />
                                    </el-form-item>
...
import { Plus, Edit, User, Setting, Upload, Check, UserFilled, InfoFilled, Lock, Key } from '@element-plus/icons-vue'
...
const rules = {
    ...
    introduction: [
        { required: true, message: '请输入博客介绍', trigger: 'blur' }
    ]
}
