<template>
    <div v-if="categories && categories.length > 0"
        ...
        <!-- 分类标题 -->
        <h2 class="mb-2 font-bold text-gray-900 uppercase dark:text-white flex items-center cursor-pointer"
            @click="goCategoryListPage()"><!-- 文件夹图标 -->
            <svg t="1698998570037" class="icon w-5 h-5 mr-2 inline-block" viewBox="0 0 1024 1024" version="1.1"
