<template>
    <div class="w-full py-5 px-2 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col items-center">
            <!-- 博主头像 -->
            <img class="w-14 h-14 mb-3 rounded-full shadow" :src="blogSettingsStore.blogSettings.avatar" />
            <!-- 博主昵称 -->
            ...
            <div class="flex justify-center mt-5 gap-2">
                ...
                <svg v-if="blogSettingsStore.blogSettings.csdnHomepage" t="1698031311586"
                    @click="jump(blogSettingsStore.blogSettings.csdnHomepage)" data-tooltip-target="csdn-tooltip-bottom"
