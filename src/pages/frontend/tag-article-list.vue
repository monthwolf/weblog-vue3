        ...
        <div class="grid grid-cols-4 gap-7">
            ...
            <div class="col-span-4 md:col-span-3 mb-3">
                ...
                <div class="p-5 mb-4 border border-gray-200 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700">
                    <h1 class="flex items-center text-lg font-semibold dark:text-white" :style="{color:tagColor}">
                        <!-- 标签图标 -->
                    ...
                    <ol v-if="articles && articles.length > 0" class="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
                        <li v-for="(article, index) in articles" :key="index">
                            <a @click="goArticleDetailPage(article.id,this)" class="items-center block p-3 sm:flex hover:bg-gray-100 dark:hover:bg-gray-700">
...
// 分类颜色
const tagColor = ref(route.query.color)

// 监听路由
watch(route, (newRoute, oldRoute) => {
    tagName.value = newRoute.query.name
    tagId.value = newRoute.query.id
    tagColor.value = newRoute.query.color
